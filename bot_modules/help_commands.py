...
async def execute(msg, args, flags):
    ...
    if (len(args) == 1 and args[0] == "help"):
        embed3 = discord.Embed(
            title = "Run the help command followed by another command to learn more about the command. In the examples given for the commands, mandatory arguments are indicated with <>, and optional arguments are indicated with ()."
        )
